...
\begin{titlepage}
    ...
    {\Large\textbf{Étudiant:} Ahmed\par}
    \vspace{0.5cm}
    {\large\textbf{Date:} 9 Janvier 2026\par}
    \vspace{0.5cm}
    {\large\textbf{Technologies:} Symfony 7 + PHP 8.2-FPM + PostgreSQL 15 + Docker\par}
...
\begin{itemize}
    ...
    \item \textbf{Étudiant} : Ahmed
    \item \textbf{Date de rendu} : 9 Janvier 2026
    \item \textbf{Technologies} : Symfony 7, PHP 8.2-FPM, PostgreSQL 15, Docker, GitLab CI/CD
    \item \textbf{Repository GitLab} : \url{https://gitlab.com/ahmedikenjatoun/rentcars_project}
    \item \textbf{Repository GitHub} : \url{https://github.com/kenjiahmed/gestion-de-location-des-voitures}
    \item \textbf{Docker Hub} : [Votre nom d'utilisateur Docker Hub]
\end{itemize}
\end{infobox}
